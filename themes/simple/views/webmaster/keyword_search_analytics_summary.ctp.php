		...
		foreach($baseReportList as $listInfo){
			...
			<tr>
				...
				foreach ($colList as $colName => $colVal){
					...
					$prevRankLink = scriptAJAXLinkHrefDialog('webmaster-tools.php', 'content', $scriptLink . "&sec=viewKeywordSearchReports&1", $prevRank);
					$currRankLink = scriptAJAXLinkHrefDialog('webmaster-tools.php', 'content', $scriptLink . "&sec=viewKeywordSearchReports&1", $currRank);
